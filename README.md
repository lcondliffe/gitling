...
activity view with day/week/month buckets, and `gitling contributors` /
`--contributors` ranks every author in range. The remaining drill-downs
(`--churn`, `--branches`) are reserved but not yet implemented.
